...
- 名词作定语时，一般用单数形式，但在个别情况下也有用复数的。例如：goods train货车，sports meeting运动会，machines hall展览机器的大厅。

- 被修饰的名词变复数时，一般情况下，作定语用的名词不需要变为复数形式，但由man或woman作定语修饰的名词变成复数时，两部分皆要变为复数形式。例如：man doctor—men doctors 男医生 woman singer—women singers 女歌手

- 名词作定语与名词所有格作定语有时是有区别的。一般来说，名词作定语通常说明被修饰的词的性质，而名词所有格作定语则强调对被修饰的词的所有（权）关系或表示逻辑上的谓语关系。例如：在“the Party members（党员）”中，名词定语表示members的性质；在“the Party's calls（党的号召）”中，Party具有动作发出者的作用，calls虽然是名词，却具有动作的含义。再举一例：a student teacher 实习教师 a student's teacher 一位学生的老师
...
- 名词当然可以用来修饰名词,叫做名词前置修饰语. 名词做前置修饰语通常用可数名词的单数形式,即使指一个以上的事物时也如此.如书店可用"a book shop"而不用"a books shop".

- 作定语的名词具有形容词的作用．一般情况下作定语的名词会用单数形式，如shoe shop, potato chip等．其中的单复数体现在主体名词中．<shop, chip>，但也有例外的，其中最多体现在表现性别的man ,woman 如果主体名词为复数，那么这两个词也要用复数形式，如，a man doctor, women teachers .

###### 知乎上解释

- 名词修饰名词的问题看上去很简单，但很多同学其实是用不好的，或者说跟本不敢用。究其原因还是大家没有了解这个问题的深层原因——即，既然已经有了形容词，为什么还要用名词来修饰名词呢？

- 很多同学想当然的认为，用名词修饰名词是因为没有相对应该的形容词，所以用名词替一下。我也听过有的老师上写作课的时候告诉学生，名词修饰名词，一定要是这个名词没有对应的形容词，才可以，如果有，一定要用形容词。但事实真的是这样吗？我们来看一个例子：

  > I was the efficiency expert for the whole famliy.
  >
  > 我在我们家是效率方面的专家。

- 在这个句子里，efficiency 很明显是名词，但是它没有对应的形容词吗？没有的话，efficient 这个词是干吗的？

- 那么，为什么这个句子有现成的形容词不用，却非要去用一个名词来修饰名词呢？从逻辑上说，那肯定是这个形容词表达不出这个名词所表达的意思，换句话说，就是名词修饰与形容词修饰，意义上是不同的。所以下面我们就来分析一下，名词修饰与形容词修饰到底有什么不同。

- 我们还是看前面的例子，我们把两个名词词组摆在一起：

  ```
  efficiency expert 效率方面的专家
  efficient expert 效率很高的专家
  ```

- 在第一个词组中，它强调的是哪一方面的专家，也就是他首先是一个专家，然后这个修饰的名词再把这个范围缩小，告诉你是效率这个方面的，不是导弹方面的，也不是茶叶蛋方面的。也就是说，这个名词 efficiency 它控制了后面的名词 expert 的范围；我们再看第二个词组，当我们用了一个形容词来修饰一个名词的时候，我们的目的就不是要控制它的范围了，而是要说明这个名词有什么样的属性——这个专家是懒散的，高效的还是龟毛的?它说的是这方面的事情。

- 当然，有同学说，不对啊，高效的不是也缩小了范围吗，它不是把不高效的排除掉了吗？这个问题是这样的，的确，形容词的修饰客观上是会造成范围的缩小，但那不是它的目的。比如当我说一个女孩漂亮的时候，我是无意于把女孩分为漂亮的和不漂亮的，我只是要说眼前的这个女孩有漂亮的属性，至于客观上造成了区分，那不是我的目的。

- 好，我说了这么多，可能有的同学已经猜出来我要说什么了。是的，我的意思就是，名词修饰名词，可以把修饰的名词看作是限定词。

- 我们在语法课里并没有说限定词和形容词的区别，我后来想写文章但内容太少又没办法独立成篇，今天正好在这里说一下。限定词和形容词的区别，就是一个是限定名词，一个是修饰名词。而限定与修饰的区别，就是我们前面说的，一个是关注范围，一个是关注属性。

- 具体例子

  ```
  一、名词定语
  horror film，恐怖电影。它指的是恐怖类的电影，不是恐怖的电影。
  safety belt，安全带。它一个带子目的是保证安全，不是安全的带子。
  Pittsburgh Airport，匹兹堡机场。座落在匹兹堡的机场，不是匹兹堡的机场。当然你要强调是匹兹堡的机场也可以，但Pittsburgh要加上’s。
  同样的：
  stone bridge，石桥；tea cup ，茶杯；dish cloth，洗碗布； grammar book(语法书)，language teacher，语言老师；village life，乡村生活；shoe shop，鞋店；afternoon tea，下午茶；top floor，顶层等。
  二、复数问题
  按道理说，作定语的名词不应该有变化的形态，但实际上也会有复数的情况出现：
  （1）本身就是复数形态
  这种情况比较好理解，比如：
  the United States government，美国政府。美国是各个州的联合政府，所以states本身就是复数。
  goods train，货物列车。复数的 goods才能表示货物。
  arms produce，武器生产。虽说单数也可以表示武器，但复数大家更容易看出来一点。
  （2）男和女
  如果说上面的还有点道理的话，下面这两个大家只能记住了。
  man doctor men doctors
  woman driver women drivers
  三、所有格
  名词与所有格的区别和名词与形容词的区别没有本质的不同，我们来看一个例子：
  a student teacher 一位实习老师
  a student’s teacher 一位学生的老师
  如果单用名词，它表示的是限定，意思是在老师这个群体里属于 student 这个阶段的老师。而第二个则强调所有关系，也就是这个老师他的属性是“这个学生的”。
  同样的例子还有：
  Sunday paper 星期日报
  the Sunday's paper 星期日的那份报纸
  和
  machine design 机器设计
  the machine's design 那台机器的设计
  等等。
  另外，有的时候，用不用所有格，区别也看不大出来，比如：
  Teachers' Training School
  Teachers Training School
  师资培训学校
  “老师的培训学校”和“培训学校中针对老师的这一部分”其实也没什么区别，所以用不用所有格区别不大，用哪个都行。
  最后提醒一下大家，我们虽然讲了这么多名词修饰名词的例子，但正常的用法还是形容词修饰名词，这才是常态，所以能用形容词的时候大家还是尽量用形容词，只有明确需要用名词的时候才能用名词。不要看了我这一篇全开始用名词修饰名词了，这样还不如不知道这个事情。
  ```
...
- 基本解释
  ...
  ```
  所有格，又称属格、领格、生格，语法范畴“格”的一种。主要表示领属、来源之类的关系。
  例如：
...
名词所有格不一定表示所有关系，有时可能表示其他意思
1、类别 a Doctor's degree 博士学位
2、表动作执行者 Mr Smith's arrival
3、动作承受者 children's education
例如：
Have you read RobertBrowning’s poems？
你读过罗伯特·勃郎宁的诗吗？
It’s made from mare’s，cow’sor ewe’s milk．
它是用马奶、牛奶或者羊奶制成的。
...
你现在可以尽情地唱了。
另外，for friendship’s sake（为了友情），at a stone’s throw（一箭之远），at one’s finger’stip（手头上有），at arm’s length（保持距离），at one’s wits’end（黔驴技穷）等都属此类。
```

###### of所有格

```
凡不能加’s的名词，都可以与of构成短语，来表示所有关系。（表示无生命的东西的所有关系）例如：
...
```
物主代词不可与 a, an, this, that, these, those, some, any, several, no, each, every, such, another, which等词一起前置修饰一个名词，而必须用双重所有格。
...
```
1.代名词的所有格表示代名词的所有。
2.人称代名词（形容词性物主代词）的所有格有my, our, your, his, her, its, their。
3.代名词的所有格必须放在名词之前,人称和数要与所有者的人称和数一致。
...
5.所有者是女性单数或拟人化的阴性,如国家、城市、船舶、飞机、月亮、地球、春天、大自然、和平、希望等以及部分动物时,代名词的所有格用her。
Jane had her hair dressed yesterday.
珍昨天去做头发了。
The moon shines her rays on all.
月光照耀在所有人身上。
6.所有者为一个动物、一件东西或婴儿时,代名词的所有格用its。
The baby is sucking its finger.
这婴儿正在吮吸他的手指。
7.所有者为复数的人、动物或东西时,代名词的所有格用their。
I'm not used to driving cars with their steering wheels at the right.
我不习惯于驾驶方向盘在右边的汽车。
8.复合人称代名词的所有格为my own, our own, your own, his own, her own, its own, their own, one's own。
9.复合人称代名词的所有格用来加强人称代名词的所有格的语气。
We have our own books.
我们有我们自己的书。
1.0复合人称代名词的所有格可以与of连用,位于被修饰的名词之后,表示所有关系。
