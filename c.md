...
- 单精度浮点数的尾数有23位，这意味着它可以表示大约 2^23个不同的值。这个数字是以二进制计数的，但我们通常更习惯于以十进制来思考。2^23 = 8388608，意思是大概10进制的话，7位10进制能表示这些数，但是这7位中超过8388608的数又不能表示，所以有效位数能正确表示的是6位，第七位可能是准确的，即小于8388608是准确的，大于8388608是不准确的，所以float的有效位数是6~7位。
